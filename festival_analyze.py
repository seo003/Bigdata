...
Original file is located at
    https://colab.research.google.com/drive/1TqxsCcJ-DesSWzgdHk8hI7C2GpEM4QTa
"""
...
def get_festival_name(region_list, year, month):
    festival_dict = {}  # 지역별로 축제 목록을 저장할 딕셔너리

    for region in region_list:
        filename = f"/content/{region}_{year}_{month}_news.json"
...
if __name__ == '__main__':
    ...
    year = 2024
    month = 1
    festival_dict = get_festival_name(region_list, year, month)
